...
class AttachmentModifiedEvent extends AbstractEvent
{
    /** @return string */
    public function getName()
    {
        return __("Attachment modified", ConfigService::TEXT_DOMAIN_NAME);
    }
    ...
    {
        return __("Whenever a attachment is modified, send a notification.", ConfigService::TEXT_DOMAIN_NAME);
    }
    ...
    {
        return __("*Attachment modified* <%attachment_url%|%attachment_name%> by %user_name% on site <%site_url%|%site_title%> at %date_time%.", ConfigService::TEXT_DOMAIN_NAME);
    }
    
    public function register()
    {
        add_action('edit_attachment', function($postId){
