...
class PostThrashedEvent extends AbstractPostEvent
{
    /** @return string */
    public function getName()
    {
        return __("On post thrashed", ConfigService::TEXT_DOMAIN_NAME);
    }
    ...
    {
        return __("Whenever a post is thrashed, send a notification.", ConfigService::TEXT_DOMAIN_NAME);
    }
    ...
    {
        return __("%user_name% *thrashed %post_type%* <%post_url%|%post_title%> on site <%site_url%|%site_title%> at %date_time%.", ConfigService::TEXT_DOMAIN_NAME);
    }
