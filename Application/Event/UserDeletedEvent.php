...
class UserDeletedEvent extends AbstractEvent
{
    ...
    {
        return __("User deleted", ConfigService::TEXT_DOMAIN_NAME);
    }
    ...
    {
        return __("Whenever a new user is deleted, send a notification.", ConfigService::TEXT_DOMAIN_NAME);
    }
    ...
    {
        return __("*User* with user id %user_id% *deleted* from site <%site_url%|%site_title%> at %date_time%.", ConfigService::TEXT_DOMAIN_NAME);
    }
